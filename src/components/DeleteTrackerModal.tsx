  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-6 space-y-4">
        <h2 className="text-lg font-medium text-ink-800">Delete "{tracker.name}"?</h2>
        ...
        {strict ? (
          <>
            ...
            <div>
              <label htmlFor="delete-tracker-confirm" className="block text-sm font-medium text-ink-700">
              ...
              <input
                ...
                autoFocus
                className="mt-1 w-full rounded-md border border-ink-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400"
              />
            </div>
          </>
        ) : (
          <p className="text-sm text-ink-600">This tracker is empty. There's nothing to lose.</p>
        )}
