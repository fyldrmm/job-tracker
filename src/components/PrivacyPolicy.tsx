  ...
  return (
    <div className="flex-1 overflow-y-auto p-6">
      ...
      <div className="max-w-2xl space-y-4 text-sm text-ink-700">
        ...
        <h3 className="font-medium text-ink-800 pt-2">What we store</h3>
        <p>
        ...
        <h3 className="font-medium text-ink-800 pt-2">Account data</h3>
        <p>
        ...
        <h3 className="font-medium text-ink-800 pt-2">What we don't do</h3>
        <p>
          We don't sell your data, use it for advertising, or track you across other sites.
        </p>

        <h3 className="font-medium text-ink-800 pt-2">Contact</h3>
        <p>
