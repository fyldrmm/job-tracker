  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-6 space-y-4">
        <h2 className="text-lg font-medium text-ink-800">Delete your account?</h2>
        ...
        <div>
          <label htmlFor="delete-confirm-text" className="block text-sm font-medium text-ink-700">
